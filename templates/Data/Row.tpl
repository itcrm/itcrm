<tr id="Data[:ID:]" class="Data [:Status:] [:Odd:] [:select:]" ondblclick="[:dblClick:]">
    ...
    <td class="action"> <div ID="exp_but[:ID:]" onClick="extend([:ID:])" class="exp_but_up exp_but "> </div><span> <a class="extra template" href="javascript:EditData([:ID:],1);"></a> </span><span> <a class="extra edit" href="javascript:EditData([:ID:]);"></a> </span><a id="restore[:ID:]" class="extra restore [:Deleted:]" href="javascript:Restore([:ID:],'Data');"></a> <a class="extra delete" href="javascript:Delete([:ID:],'Data');"></a><a class="extra changes [:Changes:]" href="/lv/Changes/[:ID:]"  target="_blank" id="changeBtn[:ID:]"></a><!-- href="javascript:showChanges([:ID:]);-->
